"""Фасад обратной совместимости: re-export prep-функций из concern-модулей.

Функции живут в ``gridstate/telemetry/{measurements,shunts,generators,rpn,on_line}.py``.
